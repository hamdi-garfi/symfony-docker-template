...
Is a based [Docker](https://www.docker.com/) project to create symfony application with docker. this project include a full [HTTP/2](https://symfony.com/doc/current/weblink.html) and HTTPS support..
